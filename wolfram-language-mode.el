...
(defvar wolfram-symbols '("AASTriangle" "AbelianGroup" "Abort" "AbortKernels" "AbortProtect"
...
"HypothesisTestData"
"I" "IconData" "Iconize" "IconizedObject"
...
"$WolframDocumentsDirectory" "$WolframID" "$WolframUUID"
  ...
  "Wolfram Language symbols that are highlighted using the keyword font.")


(defvar wolfram-font-lock-keywords
  (append
     (mapcar #'(lambda(symbol) (cons (concat "\\_<" symbol "\\_>") font-lock-keyword-face)) wolfram-symbols)
    '(
